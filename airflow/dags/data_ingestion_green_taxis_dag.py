...
with DAG(
    dag_id="data_ingestion_gcs_green_taxis_dag",
    ...
    URL_TEMPLATE = URL_PREFIX + f"/green_tripdata_{prev_month_date}.parquet"
    OUTPUT_FILE_NAME = f"green_{prev_month_date}.parquet"
